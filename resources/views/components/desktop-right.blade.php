...
<div class="col-md-7 p-0" style="margin-top:-21vw">
    <div class="containerImage">
        <div style="text-align:right">   
            <img src="/assets/client/images/Hex_Right_Path.svg" class="img-fluid" alt="Snow" style="width:93%;filter: invert(52%) sepia(78%) saturate(1172%) hue-rotate(200deg) brightness(105%) contrast(101%);">
        </div>
        <div class="top-right">
