...
<div class="col-sm-7 p-0 marginTopPortofolio wow fadeInRight" style="margin-top:-22vw">
        ...
        <div class="top-right">
            <div style="text-align:left !important;">
                <div style="display:flex;align-items: flex-start;padding-top:18%" class="portofolioTextAndImageRight">
                    ...
                    @else
                        <img id="illustration" src="{{ asset($relatedProject->featured_ilustration_file) }}" class="img-fluid" style="width:16vw;height:auto" alt="">
                    @endif
