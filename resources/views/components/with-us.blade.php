    @if($flag == '1')
    <div class="row m-0 withUsComponentHeader" style="background-color:#EDF7FF">
    <div class="col-md-12 p-0 withUsComponent">

    @else
    <div class="row m-0 withUsComponentHeader" style="padding-top:2vw;color:#142850">
    ...
    @endif
        <div class="containerImage">
            ...
            <div class="top-left">
                <div style="text-align:left !important;padding-top:3vw" class="withUsSection">
                ...
                <div style="padding-left:8.5%">
                    ...
                    <div class="row m-0" >
                        <div class="col-6" style="color:#142850">
                            ...
                            <p id="noTelp" style="font-family:HKGroteskRegular;font-size:1.8vw;margin-top:1vw">Jl. Harapan 3 No. 5, Malayka Residence <br> Bintaro, Pesanggrahan, Jakarta Selatan, 12330</p>
                        </div>
