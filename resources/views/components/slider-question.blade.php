<div class="col-md-12">
    <div class="form-group ">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center" class="mt-2">
            ...
            <input name="applicant_answers[{{ $index }}]" min="{{ $question->question_answers[0]->question_answer }}" max="{{ $question->question_answers[1]->question_answer }}" step="{{ $question->question_answers[2]->question_answer }}" type="range" class="custom-range" style="width:85%;font-family:HKGroteskRegular" id="customRange1">
