...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center;"><span style="font-size: 43px">New Project Available!&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <p><b>Decsription:</b> I want to build Something</p>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
          ...
          <span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"><a href="">click link</a></span>
        </div>
      </td>
    </tr>
  </tbody>
